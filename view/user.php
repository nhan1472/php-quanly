        ...
        <div class="col-md-12">
            <center>
                ...
                ?>
                            ...
                            if(!isset($_GET['mssv'])){
                            ?>
                                <td><input type="number" id="diem<?php echo $i;?>" name="diem<?php echo $i;?>" min=0
                                        max=<?php echo $set1[2];?> value="0" onclick="ttien()" id=""></td>
                ...
                endwhile;
                 ?>
                            ...
                            ?>
                                ...
                                <td></td>
                                <td>Tổng Điểm: <input type="number" name="tongdiem" value=0 min=0 onclick="ttien()"
                                        max=100 id="tongdiem"><br>
